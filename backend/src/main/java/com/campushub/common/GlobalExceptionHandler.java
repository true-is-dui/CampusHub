...
/**
 * 全局异常处理器，把控制器与服务层抛出的异常统一翻译成 {@link ApiResponse}，
...
public class GlobalExceptionHandler {
    ...
    /** 统一构造：HTTP 状态来自 ErrorCode，响应体为 ApiResponse。 */
    private ResponseEntity<ApiResponse<Void>> build(ErrorCode code, String message, Object errors) {
        ApiResponse<Void> body = ApiResponse.error(code, message, errors);
