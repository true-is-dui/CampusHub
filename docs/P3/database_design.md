...
**日期：** 2026-07-01  
**团队：** true就是队  
**状态：** P4 终版回溯修订，按 P1 v2.1、P2 v1.3、P3 类/API 设计和 P4 实际实现同步收敛
...
3. 支撑代取请求从发布、待接单、接单、上传完成凭证、确认完成、取消和超时取消的完整状态流转。
...
![ER 图](asset/database-er.svg)

> Mermaid 源码：[database-er.mmd](asset/database-er.mmd)
